...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "xx0su15yzu92232djrr1taek9z4jdm6uquugjnh8z7hd244v9160",
  ...
  manifest = (
    ...
    metadata = (
      ...
      icons = (
        ...
        appGrid = (png = (dpi1x = embed "../assets/logo.png")),
        grain = (png = (dpi1x = embed "../assets/logo.png")),
        #market = (svg = embed "path/to/market-150x150.svg"),
        #marketBig = (svg = embed "path/to/market-big-300x300.svg"),
      ),

      website = "https://github.com/whs/kyou",
      # This should be the app's main website url.

      codeUrl = "https://github.com/whs/kyou",
      # URL of the app's source code repository, e.g. a GitHub URL.
      # Required if you specify a license requiring redistributing code, but optional otherwise.

      license = (openSource = agpl3, notices = (defaultText = embed "../LICENSE")),
      ...
      author = (
        ...
        contactEmail = "manatsawin@gmail.com",
      ...
      shortDescription = (defaultText = "Kickass. Flying books."),
